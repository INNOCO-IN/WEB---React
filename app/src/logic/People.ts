...
/**
 * People — the roster, with each bio expanding in place.
 *
 * One hook for every language: the roster is the same people, and which
 * language their bios are read in comes off the route.
 *
 ...
 *
 * People.KO is the same component, so the roster it draws is this roster:
