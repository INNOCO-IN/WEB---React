...
import wordsen from '../i18n/resources/en/pages/workshop-shadow-shifter.json';
import wordszhTW from '../i18n/resources/zh-TW/pages/workshop-shadow-shifter.json';
import wordsko from '../i18n/resources/ko/pages/workshop-shadow-shifter.json';
import { Link } from 'react-router-dom';
import SiteLayout from '../components/SiteLayout';
import { localize, useLocale } from '../lib/lang';
import './WorkshopShadowShifter.css';

/** Workshop-Shadow-Shifter — one component for every language, generated by
 *  scripts/convert-pages.mjs from Workshop-Shadow-Shifter.EN.dc.html and its KO twin. The words live in
 *  src/i18n/resources/<locale>/pages/workshop-shadow-shifter.json; the
 *  line-heights that differ by language are custom properties in WorkshopShadowShifter.css.
 *  Edit the legacy pages, not this file. */
export default function WorkshopShadowShifter() {
  const t = usePageWords("workshop-shadow-shifter", { "en": wordsen, "zh-TW": wordszhTW, "ko": wordsko });
      ...
      <div style={{ fontFamily: "var(--font-serif)", minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <section style={{ background: "#E5188C", color: "#FAF4E2" }}>
          ...
          <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "30px 28px 56px" }}>
            ...
            <h1 style={{ fontFamily: "var(--font-serif)", fontWeight: "600", fontSize: "clamp(46px, 7vw, 96px)", lineHeight: "var(--in-workshop-shadow-shifter-0)", letterSpacing: "-0.02em", margin: "0 0 22px" }}>
              {t("002_h1")}
            </h1>
        ...
        <section style={{ maxWidth: "1320px", margin: "0 auto", padding: "44px 28px 0" }}>
          <div style={{ display: "grid", gridTemplateColumns: "190px 1fr", gap: "40px", alignItems: "baseline", borderTop: "1.5px solid rgba(46,59,64,0.25)", paddingTop: "24px" }}>
            ...
            <div style={{ maxWidth: "760px" }}>
              <p style={{ fontFamily: "var(--font-serif)", fontStyle: "var(--in-workshop-shadow-shifter-1)", fontSize: "clamp(22px, 2.4vw, 29px)", lineHeight: "1.34", margin: "0 0 20px", textWrap: "pretty" }}>
                {t("009_p")}
              </p>
              <p style={{ fontFamily: "var(--font-serif)", fontSize: "19px", lineHeight: "1.55", margin: "0", color: "rgba(46,59,64,0.82)" }}>
                {t("010_p")}
        ...
        <section style={{ maxWidth: "1320px", margin: "0 auto", padding: "34px 28px 10px" }}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "flex-start" }}>
            <figure style={{ margin: "0", flex: "0 0 auto", width: "300px", maxWidth: "100%" }}>
              <img src="/project-img/shadow-shifter.jpg" alt={t("037_alt")} style={{ display: "block", width: "100%", aspectRatio: "16/9", objectFit: "cover" }} />
            </figure>
            <figure style={{ margin: "0", flex: "0 0 auto", width: "300px", maxWidth: "100%" }}>
              <img src="/project-img/shadow-shifter4.jpg" alt={t("038_alt")} style={{ display: "block", width: "100%", aspectRatio: "16/9", objectFit: "cover" }} />
            </figure>
