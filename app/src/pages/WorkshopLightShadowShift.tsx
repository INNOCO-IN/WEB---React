...
import wordsen from '../i18n/resources/en/pages/workshop-light-shadow-shift.json';
import wordszhTW from '../i18n/resources/zh-TW/pages/workshop-light-shadow-shift.json';
import wordsko from '../i18n/resources/ko/pages/workshop-light-shadow-shift.json';
import { Link } from 'react-router-dom';
import SiteLayout from '../components/SiteLayout';
import WorkshopRegister from '../components/WorkshopRegister';
import { localize, useLocale } from '../lib/lang';
import './WorkshopLightShadowShift.css';

/** Workshop-Light-Shadow-Shift — one component for every language, generated by
 *  scripts/convert-pages.mjs from Workshop-Light-Shadow-Shift.EN.dc.html and its KO twin. The words live in
 *  src/i18n/resources/<locale>/pages/workshop-light-shadow-shift.json; the
 *  line-heights that differ by language are custom properties in WorkshopLightShadowShift.css.
 *  Edit the legacy pages, not this file. */
export default function WorkshopLightShadowShift() {
  const t = usePageWords("workshop-light-shadow-shift", { "en": wordsen, "zh-TW": wordszhTW, "ko": wordsko });
  const locale = useLocale();

  return (
    <SiteLayout page="Workshop-Light-Shadow-Shift.EN.dc.html" className="page-workshop-light-shadow-shift" footer={{ loop: "0.58", cta: "#E5188C" }}>
      <div style={{ fontFamily: "var(--font-serif)", minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <section style={{ background: "var(--color-magenta-hot)", color: "var(--color-paper)" }}>
          ...
          <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "30px 28px 56px" }}>
            ...
            <h1 style={{ fontFamily: "var(--font-serif)", fontWeight: "600", fontSize: "clamp(42px, 6.4vw, 88px)", lineHeight: "var(--in-workshop-light-shadow-shift-0)", letterSpacing: "-0.02em", margin: "0 0 22px", maxWidth: "14ch" }}>
              {t("002_h1")}
            </h1>
            <p style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(21px, 2.4vw, 30px)", lineHeight: "1.32", maxWidth: "28ch", margin: "0 0 34px", color: "rgba(250,244,226,0.94)" }}>
              {t("003_p")}
            </p>
        ...
        <section style={{ maxWidth: "1320px", margin: "0 auto", padding: "34px 28px 10px" }}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "flex-start" }}>
            <figure style={{ margin: "0", flex: "0 0 auto", width: "300px", maxWidth: "100%" }}>
              <img src="/project-img/light-shadow-shift-women.jpg" alt={t("035_alt")} style={{ display: "block", width: "100%", aspectRatio: "16/9", objectFit: "cover" }} />
            </figure>
            <figure style={{ margin: "0", flex: "0 0 auto", width: "300px", maxWidth: "100%" }}>
              <img src="/project-img/light-shadow-shift-women4.jpg" alt={t("036_alt")} style={{ display: "block", width: "100%", aspectRatio: "16/9", objectFit: "cover" }} />
            </figure>
        ...
        <section id="register" style={{ background: "var(--color-magenta-hot)", color: "var(--color-paper)" }}>
          <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "70px 28px", textAlign: "center" }}>
            ...
            <WorkshopRegister slug="light-shadow-shift" accent="#E5188C" />
