...
import wordsen from '../i18n/resources/en/pages/workshop-second-life.json';
import wordszhTW from '../i18n/resources/zh-TW/pages/workshop-second-life.json';
import wordsko from '../i18n/resources/ko/pages/workshop-second-life.json';
...
/** Workshop-Second-Life — one component for every language, generated by
 *  scripts/convert-pages.mjs from Workshop-Second-Life.EN.dc.html and its KO twin. The words live in
 *  src/i18n/resources/<locale>/pages/workshop-second-life.json; the
 *  line-heights that differ by language are custom properties in WorkshopSecondLife.css.
 *  Edit the legacy pages, not this file. */
export default function WorkshopSecondLife() {
  const t = usePageWords("workshop-second-life", { "en": wordsen, "zh-TW": wordszhTW, "ko": wordsko });
      ...
      <div style={{ fontFamily: "var(--font-serif)", minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <section style={{ background: "#E5188C", color: "#FAF4E2" }}>
          ...
          <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "30px 28px 56px" }}>
            ...
            <h1 style={{ fontFamily: "var(--font-serif)", fontWeight: "600", fontSize: "clamp(44px, 6.6vw, 92px)", lineHeight: "var(--in-workshop-second-life-0)", letterSpacing: "-0.02em", margin: "0 0 22px", maxWidth: "12ch" }}>
              {t("002_h1")}
            </h1>
        ...
        <section style={{ maxWidth: "1320px", margin: "0 auto", padding: "40px 28px" }}>
          <div style={{ background: "#CDE3CF", padding: "44px 44px 40px" }}>
            ...
            <p style={{ fontFamily: "var(--font-serif)", fontStyle: "var(--in-workshop-second-life-1)", fontSize: "18px", lineHeight: "1.5", margin: "0", color: "rgba(46,59,64,0.7)" }}>
              {t("033_p")}
            </p>
          </div>
        </section>
