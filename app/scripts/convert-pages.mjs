 ...
 *
 * Every pair that has both editions is listed. Being a candidate costs nothing:
 * a pair whose two editions have drifted is reported and left as two, so the
 * list is a question the converter answers rather than a claim about the pages.
 * The 2026 design wrote a Korean twin for twenty-seven pages that had none, and
 * a page in two languages is the case this exists for.
 */
const COLLAPSED_CANDIDATES = [
  'Action-Research', 'Are-you-IN', 'BridgeBuilder', 'Community',
  'Community-Animators', 'Community-BridgeBuilders',
  'Community-Facilitators', 'Community-IN-Collectives', 'Community-Index',
  'Community-Nepal-Youth-Cluster', 'Community-Open-Studio',
  'Community-UAE-Youth-Cluster', 'Constellation', 'Home', 'MEWE',
  'Manifesto', 'News', 'Pathway', 'People', 'Project',
  'Project-Asia-Exchange', 'Project-BridgeBuilder-Program', 'Project-CTN',
  'Project-Food-Revolution', 'Project-GYEM', 'Project-I-Grow-Seed',
  'Project-Jungle-Jam', 'Project-Light-Shadow-Shift-Womens-Retreat',
  'Project-Shadow-Shifter', 'Project-UAE-Youth-Social-Innovation',
  'Project-UNC', 'Project-UNC-Documentary', 'Project-tasmena', 'Story',
  'Story-Index', 'Story-Submission', 'Workshop', 'Workshop-Bucket-List',
  'Workshop-Heros-Journey', 'Workshop-Jungle-Jam',
  'Workshop-Light-Shadow-Shift', 'Workshop-Metanoia',
  'Workshop-Mobius-Making', 'Workshop-Pathfinder', 'Workshop-Second-Life',
  'Workshop-Shadow-Shifter', 'Workshop-Two-Wings',
];
...
${Object.entries(RENAMED_ROUTES).map(([from, to]) => `  ${JSON.stringify(from)}: ${JSON.stringify(to)},`).join('\n')}
};
